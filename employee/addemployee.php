...
if(isset($_POST['BtnS']))
{
   ...
   //profile
        ...
        $sql="INSERT INTO `tbl_systemuser` (`user_id`, `fname`, `lname`, `mobileno`, `email`, `gender`, `area_id`, `full_add`, `photo`, `dob`, `doj`, `role_id`, `status`) VALUES (NULL, '$fname', '$lname', '$mno', '$email', '$gender', '$area', '$address', '$file_name1', '$bod', '$doj', '2', '1')";
...
<div class='col-md-8'>
  ...
  <form method='post'  enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" id="mno" placeholder="Enter your mobile number" name="mno">
    </div>
    <div class="form-group">
    ...
    <label><b>Gender:</b></label><br>
      ...
      male
      <input type="radio" id="f" value="2" name="gender">
      female
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" id="address" placeholder="Enter address" name="address"  rows="10" cols="30"></textarea>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="date" class="form-control" id="doj" placeholder="Enter joining date" name="doj">
    </div>
